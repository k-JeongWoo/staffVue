          ...
          <form action="">
            <div class="login_box mt8">
              <p class="input error"><!--에러의 경우 error 클래스 추가하시면 붉은색으로 border처리됩니다.-->
                <input type="text" v-model="usr_id" v-on:keyup.enter="loginAccess" placeholder="아이디">
              </p>
              <p class="input mt3">
                <input type="password" v-model="usr_password" v-on:keyup.enter="loginAccess" placeholder="비밀번호">
              </p>
              ...
              <div class="login_errorBox" v-if="loginCheck === false">
